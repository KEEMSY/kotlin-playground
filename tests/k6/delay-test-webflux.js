...
export default function () {
    // Test the non-blocking delay endpoint
    ...
    if (response.status === 200) {
        ...
        if (Math.random() < 0.01) {
            console.log(`WebFlux Start: ${body.startThread}, End: ${body.endThread}, Delay: ${body.actualDelay}ms`);
        }
    }
...
export function handleSummary(data) {
    return {
        ...
        'results/webflux-delay-test.json': JSON.stringify(data, null, 2),
    };
}
...
function textSummary(data, opts) {
    ...
    let summary = `
================================================================================
WEBFLUX DELAY TEST RESULTS (Non-blocking - Coroutine delay)
================================================================================
